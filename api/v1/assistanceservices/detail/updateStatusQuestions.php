<?php
    ...
    */
    ...
    /*
        Parameters
    */
    $questions_id = param($request['questions_id']);;
        ...
        */
        ...
        try{
            ...
            */
            ...
            $stmt = $con->prepare("UPDATE questions SET status=1 WHERE questions_id=?");   
                
            $stmt->bind_param("i", $questions_id);
            ...
            */
            updateStatusQuestions($questions_id);
        }catch(Exception $e){
            /*
                Function location in : /model/general/functions.php
            */
